...
function onLoad(event) {
	addJavaScriptDependancy('media:///svyComponent/svyComponent.js')
	addJavaScriptDependancy('media:///svyComponent/svyComponentCallback.js')
}
...
function persistObject(object, incrementalUpdateCode) {
	throw new scopes.svyExceptions.AbstractMethodInvocationException('Abstract method persistObject() must be implemented on instances of AbstractComponent');
}
...
function desistObject(id) {
	throw new scopes.svyExceptions.AbstractMethodInvocationException('Abstract method desistObject() must be implemented on instances of AbstractComponent');
}
...
function getComponentId(){
	throw new scopes.svyExceptions.AbstractMethodInvocationException('Abstract method getComponentId() must be implemented on instances of AbstractComponent');
}
...
function addJavaScriptDependancy(url) {	
	throw new scopes.svyExceptions.AbstractMethodInvocationException('Abstract method addJavaScriptDependancy() must be implemented on instances of AbstractComponent');
}
...
function addCSSDependancy(url) {	
	throw new scopes.svyExceptions.AbstractMethodInvocationException('Abstract method addCSSDependancy() must be implemented on instances of AbstractComponent');
}